...
HD_PWD='C:/Users/GERMAN/Desktop/universidad/4_cuarto/Diseo Automatico de Sistemas/DAS/labs/projects/ProyectoFinal/ProyectoFinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pFinal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pFinal.tcl
